...
def make_args_parser():
    ...
    ##### Dataset #####
    parser.add_argument(
        "--dataset_name", type=str, choices=["mynet", "sunrgbd","scannet"], default="scannet"
    )
    parser.add_argument(
        "--dataset_root_dir",
        type=str,
    ...
    parser.add_argument("--test_ckpt", default='/media/kou/Data1/htc/Chat-3D-v2/V-DETR/ckpt/mymodel.pth/checkpoint_0040.pth', type=str)
...
def auto_reload(args):
    ignore_keys = [
    "test_only", "auto_test", "test_no_nms", "no_3d_nms", "rotated_nms","batchsize_per_gpu",
    ...
    "ngpus","dist_url","model_name","dataset_root_dir","meta_data_dir","checkpoint_dir","dataset_name"
    ]
